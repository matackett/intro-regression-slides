...
The data provide sufficient evidence that the population slope $\beta_0$ is different from 0. 
...
### What is a plausible range of values of values for the population slope $\beta_1$?
...
.small[$t^*$ is calculated from a $t$ distribution with $n-2$ degrees of freedom]
