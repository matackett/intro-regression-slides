...
.pull-right[
.small-box-work[
$$\begin{aligned}R^2 &= \frac{548.092}{847.625} \\[5pt]
&= 0.647\end{aligned}$$ 
]
]
...
.vocab[P-value]: Probability of observing a test statistic at least as extreme as *F Stat* given the true slope parameter is 0, i.e. $H_0: \beta_1 = 0$ 
...
The data provide strong evidence that the true slope parameter, $\beta_1$, is different from 0. 
